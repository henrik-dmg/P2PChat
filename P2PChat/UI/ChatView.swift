...
#Preview("Message Bubbles") {
    VStack {
        ScrollView(.vertical) {
            VStack(spacing: 8) {
                ChatMessageCellView(message: PreviewMessage(date: .now, content: "Test message", sender: "me", recipient: "you"), ownPeerID: "me")
                ChatMessageCellView(message: PreviewMessage(date: .now, content: "Test message", sender: "you", recipient: "me"), ownPeerID: "me")
                ChatMessageCellView(message: PreviewMessage(date: .now, content: "Test message", sender: "me", recipient: "you"), ownPeerID: "me")
                ChatMessageCellView(message: PreviewMessage(date: .now, content: "Test message", sender: "you", recipient: "me"), ownPeerID: "me")
            }.padding(.horizontal)
        }.defaultScrollAnchor(.bottom)
